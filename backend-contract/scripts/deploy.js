const main = async () => {
    ...
    await txn.wait();
    console.log("Minted domain kushaal.blockcoders");
  
    txn = await domainContract.setRecord("kushaal", "Are you a brokie or TOPG");
    await txn.wait();
    console.log("Set record for kushaal.blockcoders");
